defmodule MetricActorBridge do 
  ...
  def start_link(account_id, metric_name, tick_type, initial_value, tags_json, operation, cleanup_after_seconds, metric_type, metadata, plan_limit_value, plan_limit_operator, plan_breach_action)      
